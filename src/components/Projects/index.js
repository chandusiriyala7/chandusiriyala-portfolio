  ...
  return (
    <Container id="projects">
      <Wrapper>
        ...
        <Desc>
          I have worked on a wide range of projects. From web apps to AI related Apps. Here are some of my projects.
        </Desc>
        <ToggleButtonGroup >
          {toggle === 'all' ?
          ...
          <Divider />
          {toggle === 'android app' ?
            <ToggleButton active value="android app" onClick={() => setToggle('android app')}>AI-Based Apps</ToggleButton>
            :
            <ToggleButton value="android app" onClick={() => setToggle('android app')}>AI-Based Apps</ToggleButton>
          }
          <Divider />
